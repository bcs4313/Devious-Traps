...
namespace DeviousTraps.src
{
    ...
    internal class MortarConfig
    {
        ...
        public static void BindMortarConfig(Plugin pluginRef)
        {
            ...
            MortarReloadTime = pluginRef.Config.Bind("Mortar Turret", "Time Between Salvos", 44f, "Length of time before the mortar can fire another salvo, in seconds. (default 34)");
